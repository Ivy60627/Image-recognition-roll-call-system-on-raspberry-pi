...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_temp.setGeometry(QtCore.QRect(650, 400, 250, 150))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
        ...
        self.label_humi = QtWidgets.QLabel(self.centralwidget_main)
        self.label_humi.setGeometry(QtCore.QRect(900, 400, 250, 150))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(20)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_humi.setText(_translate("MainWindow", "TextLabel_humi"))
